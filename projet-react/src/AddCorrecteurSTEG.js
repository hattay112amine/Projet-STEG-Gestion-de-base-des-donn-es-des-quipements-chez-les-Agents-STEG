...
function AddCorrecteurSTEG() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Correcteurs_STEG', formData)
      .then(response => {
        alert('Correcteur_STEG ajouté avec succès');
        navigate('/components/Correcteurs_STEG');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Correcteur_STEG </h2>
...
export default AddCorrecteurSTEG;