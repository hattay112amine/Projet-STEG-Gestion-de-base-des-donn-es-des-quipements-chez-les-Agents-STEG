...
function AddCompteurMembraneSTEG() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Compteur_Membrane_STEG', formData)
      .then(response => {
        alert('Compteur_Membrane_STEG ajouté avec succès');
        navigate('/components/Compteur_Membrane_STEG');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Compteur_Membrane_STEG</h2>
...
export default AddCompteurMembraneSTEG;