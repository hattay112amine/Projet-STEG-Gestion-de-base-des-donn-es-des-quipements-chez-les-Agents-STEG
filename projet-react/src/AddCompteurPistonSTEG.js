...
function AddCompteurPistonSTEG() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Compteur_Piston_STEG', formData)
      .then(response => {
        alert('Compteur_Piston_STEG ajouté avec succès');
        navigate('/components/Compteur_Piston_STEG');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Compteur_Piston Rotatifs_STEG</h2>
...
export default AddCompteurPistonSTEG;
