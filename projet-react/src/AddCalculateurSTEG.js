...
function AddCalculateurSTEG() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Calculateurs_STEG', formData)
      .then(response => {
        alert('Calculateur_STEG ajouté avec succès');
        navigate('/components/Calculateurs_STEG');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Calculateur_STEG </h2>
...
export default AddCalculateurSTEG;