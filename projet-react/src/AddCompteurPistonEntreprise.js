...
function AddCompteurPistonEntreprise() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Compteur_Piston_Entreprise', formData)
      .then(response => {
        alert('Compteur_Piston_Entreprise ajouté avec succès');
        navigate('/components/Compteur_Piston_Entreprise');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Compteur_Piston Rotatifs_Entreprise</h2>
...
export default AddCompteurPistonEntreprise;