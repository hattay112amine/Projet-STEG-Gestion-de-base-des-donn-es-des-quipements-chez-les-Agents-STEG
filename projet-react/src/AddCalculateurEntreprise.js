...
function AddCalculateurEntreprise() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Calculateurs_Entreprise', formData)
      .then(response => {
        alert('Calculateur_Entreprise ajouté avec succès');
        navigate('/components/Calculateurs_Entreprise');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Calculateur_Entreprise </h2>
...
export default AddCalculateurEntreprise;