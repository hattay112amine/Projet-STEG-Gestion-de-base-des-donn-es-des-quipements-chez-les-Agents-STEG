...
function Correcteurs_Entreprise() {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/components/Correcteurs_Entreprise')
      .then(response => {
  ...
  return (
    <div className="container">
      <div className="mb-4">
        <Link to="/AddCorrecteurEntreprise" className="btn btn-success">Ajouter un nouveau Correcteur_Entreprise</Link>
      </div>
          ...
          <table className="custom-table">
            <thead>
              <tr>
                ...
                <th>Désignation de l'appareil :T / O</th>
            ...
            <tbody>
              {filteredData.map(item => (
                <tr key={item['Désignation de l\'appareil/N° Série']}>
                  ...
                  <td>{item['Désignation de l\'appareil :T / O']}</td>
                  ...
                  <td>{item['Etat']}</td>
                  <td>
                    <Link to={`/details_Correcteurs_Entreprise/${item['Désignation de l\'appareil/N° Série']}`} className="btn btn-primary">Voir détails</Link>
                  </td>
                </tr>
              ))}
            </tbody>
...
export default Correcteurs_Entreprise;