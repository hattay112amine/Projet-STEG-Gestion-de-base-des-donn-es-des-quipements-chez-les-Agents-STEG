...
function AddManometreEntreprise() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Mano_entreprise', formData)
      .then(response => {
        alert('Manometre_entreprise ajouté avec succès');
        navigate('/components/Mano_entreprise');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Manometre_STEG </h2>
...
export default AddManometreEntreprise;