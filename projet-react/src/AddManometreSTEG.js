...
function AddManometreSTEG() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Mano_STEG', formData)
      .then(response => {
        alert('Manometre_STEG ajouté avec succès');
        navigate('/components/Mano_STEG');
      })
      .catch(error => {
...
export default AddManometreSTEG;