...
function AddCompteurTurbineEntreprise() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Compteur_Turbine_Entreprise', formData)
      .then(response => {
        alert('Compteur_Turbine_Entreprise ajouté avec succès');
        navigate('/components/Compteur_Turbine_Entreprise');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Compteur_Turbine_Entreprise</h2>
...
export default AddCompteurTurbineEntreprise;