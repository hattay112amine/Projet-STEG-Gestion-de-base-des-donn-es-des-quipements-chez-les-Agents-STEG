...
function AddCompteurTurbineSTEG() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/api/components/Compteur_Turbine_STEG', formData)
      .then(response => {
        alert('Compteur_Turbine_STEG ajouté avec succès');
        navigate('/components/Compteur_Turbine_STEG');
      })
      .catch(error => {
  ...
  return (
    <div className="container3">
      <h2>Ajouter un nouveau Compteur_Turbine_STEG</h2>
...
export default AddCompteurTurbineSTEG;
